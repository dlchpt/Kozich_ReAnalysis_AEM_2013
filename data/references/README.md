# Download the SILVA reference file (v123). We will pull out the bacteria-specific sequences and clean up the directories to remove the extra files
...
# Download the RDP taxonomy references (v14), put the necessary files in data/references, and clean up the directories to remove the extra files
